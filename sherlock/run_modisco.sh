...
python3 visualize_motif_matches.py -m $output_dir/modisco_results_allChroms_$score_type.hdf5 -t $output_dir/$score_type.tomtom.tsv -o $output_dir \
      -vd $vier_db -th 0.3 -hl http://mitra.stanford.edu/kundaje/anusri/chromatin_atlas/modisco/$data_type/$cell_type/ -vhl http://mitra.stanford.edu/kundaje/anusri/chromatin_atlas/modisco/vierstra_logos/ \
