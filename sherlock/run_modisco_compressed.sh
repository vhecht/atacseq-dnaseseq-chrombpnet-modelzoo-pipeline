...
echo "singularity exec /home/groups/akundaje/anusri/simg/tf-atlas_latest.sif bash script_modisco_compressed.sh $scores_prefix $score_type $output_dir $seqlets $crop"
singularity exec /home/groups/akundaje/anusri/simg/tf-atlas_latest.sif bash script_modisco_compressed.sh $scores_prefix $score_type $output_dir $seqlets $crop $regions $genome
