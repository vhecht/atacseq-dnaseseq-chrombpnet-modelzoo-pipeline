...
echo "singularity exec /home/groups/akundaje/anusri/simg/tf-atlas_latest.sif python get_bed_regions_to_fill_atac.py -i $input_dir -if $model1  -o $output -e $experiment -t $type"
singularity exec /home/groups/akundaje/anusri/simg/tf-atlas_latest.sif python get_bed_regions_to_fill_atac.py -i $input_dir -if $model1  -o $output -e $experiment -t $type
