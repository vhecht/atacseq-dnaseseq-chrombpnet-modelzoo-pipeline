...
output_bigwig_prefix=/scratch/groups/akundaje/anusri/chromatin_atlas/full_deepshaps/bigwigs/DNASE/$experiment/$model1/$experiment

regions=$output".final.counts.bed"
