...
#start_conversion.sh
#start_bed_formatting.sh
#chrombppnet_model_encsr283tme_bias
#chrombppnet_model_encsr283tme_bias_fold
...
for encode_id in encode_ids[200:]:
	...
	command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_0" + " " + "chrombppnet_model_encsr283tme_bias"
	print(command)
	os.system(command)

	command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_1" + " " + "chrombppnet_model_encsr283tme_bias_fold_1"
	print(command)
	os.system(command)

	command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_2" + " " + "chrombppnet_model_encsr283tme_bias_fold_2"
	print(command)
	os.system(command)

	command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_3" + " " + "chrombppnet_model_encsr283tme_bias_fold_3"
	print(command)
	os.system(command)

	command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_4" + " " + "chrombppnet_model_encsr283tme_bias_fold_4"
	print(command)
	os.system(command)
