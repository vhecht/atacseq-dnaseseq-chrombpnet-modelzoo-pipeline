...
for encode_id in encode_ids[200:]:
	...
	#command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_0" + " " + "chrombpnet_model_feb15"
	#print(command)
	#os.system(command)

	#command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_1" + " " + "chrombpnet_model_feb15_fold_1"
	#print(command)
	#os.system(command)

	#command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_2" + " " + "chrombpnet_model_feb15_fold_2"
	#print(command)
	#os.system(command)

	#command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_3" + " " + "chrombpnet_model_feb15_fold_3"
	#print(command)
	#os.system(command)

	#command = "bash start_bed_formatting.sh " + encode_id + " " + oak_dir + " " + "fold_4" + " " + "chrombpnet_model_feb15_fold_4"
	#print(command)
	#os.system(command)


	command = "bash start_conversion.sh " + encode_id + " " + oak_dir + " " + "fold_0" + " " + "chrombpnet_model_feb15"
	print(command)
	os.system(command)

	command = "bash start_conversion.sh " + encode_id + " " + oak_dir + " " + "fold_1" + " " + "chrombpnet_model_feb15_fold_1"
	print(command)
	os.system(command)

	command = "bash start_conversion.sh " + encode_id + " " + oak_dir + " " + "fold_2" + " " + "chrombpnet_model_feb15_fold_2"
	print(command)
	os.system(command)

	command = "bash start_conversion.sh " + encode_id + " " + oak_dir + " " + "fold_3" + " " + "chrombpnet_model_feb15_fold_3"
	print(command)
	os.system(command)

	command = "bash start_conversion.sh " + encode_id + " " + oak_dir + " " + "fold_4" + " " + "chrombpnet_model_feb15_fold_4"
	print(command)
	os.system(command)
