...
for encid in encids:
	...
	print(encid)
	top_100k_modisco="/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/"+encid+"/preprocessing/downloads/100K.ranked.subsample.overlap.bed"
	if os.path.isfile(top_100k_modisco):
		...
		if peak_top.shape[0] < 100000:
			peaks="/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/"+encid+"/preprocessing/downloads/peaks.bed.gz"
		...
		bed_dir_int="/oak/stanford/groups/akundaje/projects/chromatin-atlas-2022/DNASE/"+encid+"/interpret_uploads/"
...
df.to_csv("dnase_logs/dnase_modisco_input_bed_file_making.tsv", sep="\t", header=None, index=False)